	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.forename}">
				<li class="fieldcontain">
					<span id="forename-label" class="property-label"><g:message code="user.forename.label" default="Forename" /></span>
					
						<span class="property-value" aria-labelledby="forename-label"><g:fieldValue bean="${userInstance}" field="forename"/></span>
