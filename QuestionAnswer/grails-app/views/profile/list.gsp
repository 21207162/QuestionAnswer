			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="status" title="${message(code: 'profile.status.label', default: 'Status')}" />
				...
				<g:each in="${profileInstanceList}" status="i" var="profileInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${profileInstance.id}">${fieldValue(bean: profileInstance, field: "status")}</g:link></td>
